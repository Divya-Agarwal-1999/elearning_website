        ...
        <div class="container bg-white my-md-3 my-lg-5 my-sm-1">
            <div class="row justify-content-center g-0 mt-md-5 mt-2 p-1">
                <form class="row g-3" style="min-height:75vh; width:800px;" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-0 g-0">
                        <label for="exampleFormControlTitle1" class="form-label" style="font-size:20px; color:black;">Title</label>
                        <input type="text" class="form-control" id="exampleFormControlTitle1" name="title" required  maxlength="28">
                    </div>
                    <div class="mb-0 g-0">
                        <label for="exampleFormControlTextarea1" class="form-label" style="font-size:20px; color:black;">Description</label>
                    ...
                    <div class="col-12">
                        <button class="btn btn-danger" type="submit" name="add">Add Course</button>
                      </div>
                </form>
            </div>
        </div>
